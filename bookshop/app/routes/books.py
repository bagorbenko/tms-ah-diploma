...
def create_book():
    ...
    try:
        ...
        # Проверка существования автора и категории
...
def update_book(book_id):
    ...
    try:
        ...
        # Проверка уникальности ISBN при изменении
        if 'isbn' in data and data['isbn'] != book.isbn:
            existing_book = Book.query.filter_by(isbn=data['isbn']).first()
            if existing_book:
                return jsonify({'error': 'Книга с таким ISBN уже существует'}), 400
        
        # Проверка существования автора и категории при изменении
...
def delete_book(book_id):
    ...
    try:
        ...
        # Проверяем, есть ли активные заказы с этой книгой
        if book.order_items:
            return jsonify({
